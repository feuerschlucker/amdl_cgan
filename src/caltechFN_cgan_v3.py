...
def define_generator(latent_dim, n_classes=10):
    ...
    # Adjust the size of the embedding for generator to match 14x25x128
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=5, n_batch=128):
    ...
    g_model.save('models/FN_balanced_30epochs_double_gen.keras')
    ...
    plt.legend()
    plt.savefig('plots/loss_plot_30epochs_double_gen.png')
    plt.show()
